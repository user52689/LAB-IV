...
public class ListarPrestamosClienteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Obtener préstamos del cliente con saldo pendiente calculado
            List<Prestamo> prestamos = prestamoNegocio.listarPorClienteConSaldo(idCliente);
            request.setAttribute("prestamosCliente", prestamos);
            System.out.println("[DEBUG] ListarPrestamosClienteServlet: Cargados " + prestamos.size() + " préstamos para idCliente = " + idCliente);
