     ...
     <main class="flex-grow-1 bg-light p-4">
         <div class="container">
             ...
             <div style="display: none;">
                 <p>DEBUG: cuota = ${cuota}</p>
                 <p>DEBUG: cuota.prestamo = ${cuota.prestamo}</p>
                 <p>DEBUG: cuota.prestamo.idPrestamo = <c:out value="${cuota.prestamo.idPrestamo}" /></p>
                 <p>DEBUG: cuota.montoCuota = <c:out value="${cuota.montoCuota}" /></p>
                 <p>DEBUG: cuota.numeroCuota = <c:out value="${cuota.numeroCuota}" /></p>
                 <p>DEBUG: totalCuotas = <c:out value="${totalCuotas}" /></p>
                 <p>DEBUG: cuentas = ${cuentas}</p>
             </div>
                     ...
                     <form action="<%=request.getContextPath()%>/Prestamos/pagar" method="post" class="w-50 mx-auto">
                         ...
                         <div class="mb-3">
                             ...
                             <select name="idPrestamoDisplay" id="idPrestamo" class="form-select" disabled>
                                 <option value="<c:out value='${cuota.prestamo.idPrestamo}' />" 
                                         data-monto="${cuota.montoCuota}" 
                                         data-cuota="${cuota.numeroCuota}" 
                                         data-total="${totalCuotas}">
                                     Préstamo <c:out value="${cuota.prestamo.idPrestamo}" /> - Pendiente: 
             ...
             <div class="mb-3 row mt-4">
                 <div class="col-sm-12 text-center">
                     <a href="<%= request.getContextPath() %>/ListarPrestamosClienteServlet" class="btn btn-secondary">
